...
void selectMain2();	//Highlighting the "Group Members" Text in Red
void selectMain3();	//Highlighting the "Exit" Text in Red
...
void groupMember();	//Displays Group Members' Name
...
void Color(int ColorValue)	//Change Color of Text
{
...
void groupMember()
{
	...
	puts("\t\t\t\t\t\t       =============\n");
	Color(10);
	puts("\t\t\t\t\tHans William Christianto Wijaya - 2602079331");
	puts("");
	puts("\t\t\t\t\t  Florenze Albertine Tatuwey - 2602072022");
	puts("");
	puts("\t\t\t\t\t  Evander Octavianus Layardi - 2602075983");
	puts("");
	puts("\t\t\t\t\t     Jeffline Kristian D. - 2602077156");
	puts("");
	puts("\t\t\t\t\t  Benedict Zevanno Christabel - 2602056851");
	Color(7);
	getchar();
}
...
{
	printf("\n\n\n\n\n\n\n\n\n\t\t");
	printf("\"Wonderful Things Can be Achieved When There's Teamwork, Hardwork, and Perseverance\"");
	printf("\n\n\n\n\n\n\n\t\t");
